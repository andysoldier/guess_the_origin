...
tp @a[scores={GTO_playerId=1}] ~2 ~ ~
tp @a[scores={GTO_playerId=2}] ~2 ~ ~2
tp @a[scores={GTO_playerId=3}] ~ ~ ~2
tp @a[scores={GTO_playerId=4}] ~-2 ~ ~2
tp @a[scores={GTO_playerId=5}] ~-2 ~ ~
tp @a[scores={GTO_playerId=6}] ~-2 ~ ~-2
tp @a[scores={GTO_playerId=7}] ~ ~ ~-2
tp @a[scores={GTO_playerId=8}] ~2 ~ ~-2
execute at @e[type=marker,name=gto_campfire] run spreadplayers ~ ~ 1 2 false